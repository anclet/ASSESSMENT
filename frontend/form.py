...
#     # Debugging: print the field values and check their validity
#     st.write("Debugging form field values:")
...
#                     st.experimental_rerun()  # Reset the form by rerunning the script
#                 else:
